...
class depth_new(srdata.SRData):
    def __init__(self, args, name='depth_new', train=True, benchmark=False):
        ...
        super(depth_new, self).__init__(
            args, name=name, train=train, benchmark=benchmark
        )

    def _scan(self):
        names_hr, names_lr = super(depth_new, self)._scan()
    ...
    def _set_filesystem(self, dir_data):
        super(depth_new, self)._set_filesystem(dir_data)
